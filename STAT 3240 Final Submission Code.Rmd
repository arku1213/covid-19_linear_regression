---
title: "STAT 3240 Final Submission Code"
author:
  - "Arnab Kundu"
  - "Jeremiah Osorio"
  - "Jacob Tweel"
...
As you can see from our Box Cox plots, we found that a transformation of the 5th root to the GDP Per Capita and Poverty Rate allows for an accurate representation as it will help correct the extreme right skewness. We chose to apply a log to Child Mortality Rate as the Box Cox plot showed lambda at 0.
...
We transformed the outcome variable of Total Deaths per Million to the 5th root as we felt it best accurately showcases the data within a box plot. This also better encapsulates the variance and outliers
...
- Jeremiah Osorio - Reporter
- Arnab Kundu - Time Keeper & Recorder
- Jacob Tweel - Facilitator
- Pranav Bangla - Checker

## Individual Contribution

*If your group were to earn 5 points on this submission, how should those points be shared across your group members?*

- Jeremiah Osorio - 1.5 pt
- Arnab Kundu - 1.5 pt
- Jacob Tweel - 1.5 pt
- Pranav Bangla - 0.5 pt
